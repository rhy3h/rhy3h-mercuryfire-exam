  ...
  <header class="bg-white border-b border-gray-200 py-4">
    <div class="max-w-7xl mx-auto w-full px-4 sm:px-6 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        >
          <Users class="text-white" :size="18" :stroke-width="2" />
        </div>
        <div class="flex flex-col gap-y-1">
          <h1 class="text-xl font-bold text-gray-800 leading-tight">帳號管理系統</h1>
          <p class="text-base text-gray-400 leading-tight">管理您的所有帳號</p>
        </div>
      </div>
